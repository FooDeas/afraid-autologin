...
RUN wget -c https://github.com/mozilla/geckodriver/releases/download/v0.35.0/geckodriver-v0.35.0-linux64.tar.gz && tar -xzf geckodriver-v0.35.0-linux64.tar.gz -C /usr/local/bin/
